...
class ChatSession(Base):
    ...
    name: Mapped[str] = mapped_column(String(length=MAX_CHAT_NAME_LENGTH), nullable=False, default="Новый чат")
...
class GenerationResult(Base):
    ...
    attachment: Mapped[Attachment | None] = relationship(
        "Attachment", back_populates="generation_result", uselist=False
    )
...
class Attachment(Base):
    ...
    generation_result: Mapped[GenerationResult | None] = relationship(
        "GenerationResult", back_populates="attachment", cascade="all", uselist=False
    )
