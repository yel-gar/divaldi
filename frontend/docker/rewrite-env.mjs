...
// Substitutes the build-time BACKEND_BASE_URL variable into the Angular
// environment file before `ng build` runs. The compose file passes
// BACKEND_BASE_URL as a build arg; the Dockerfile forwards it here.
//
// Fallback: when BACKEND_BASE_URL is not set (e.g. a plain `ng build`
